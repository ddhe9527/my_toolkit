...
echo "Postinstallation: set root@localhost's password: "`tput setaf 1; tput bold`$ROOT_PASSWD`tput sgr0`
...
echo "Postinstallation: replication database account 'repl' has been created, password: "`tput setaf 1; tput bold`$REPL_PASSWD`tput sgr0`
